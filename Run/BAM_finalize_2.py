...
base_folder = "bam_analysis_results"
input_file = os.path.join(base_folder, "genome_results.txt")
picard_file = os.path.join(base_folder, "picard_output.txt")
...
collect_file = os.path.join(base_folder, "collect_bases_metrics.txt")
...
raw_data_folder = os.path.join(base_folder, "raw_data_qualimapReport")
...
print(f"[INFO] All processing complete! {input_file} and files in raw_data_qualimapReport/ are ready for MultiQC.")
